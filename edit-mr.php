  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Rekam Medis</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <!-- Small boxes (Stat box) -->
          ...
          <div class="col-12">
            <div class="card card-primary">
              ...
              $query = mysqli_query($koneksi, "SELECT * FROM data_mr WHERE no_rm = '$ambilno' ");
              
              $data = mysqli_fetch_array($query);
              ?>
			<form method="POST" action="proseseditmr.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
					...
					value="<?php echo $data['dokter_pemeriksa'] ?>" >
                  </div>
