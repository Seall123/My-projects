        ...
        <!-- Small boxes (Stat box) -->
          ...
          <div class="col-12">
            <div class="card card-primary">
              ...
              $query = mysqli_query($koneksi, "SELECT * FROM data_dokter WHERE id_dokter = '$ambilid' ");
              
              $data = mysqli_fetch_array($query);
              ?>
			<form method="POST" action="proseseditdokter.php">
                <div class="card-body">
...
<div class="form-group">
 ...
 <div class="form-group">
					...
					<select class="form-control" name="jadwal_dokter">
						...
						value="<?php echo $data['jadwal_dokter']; ?>" >
					</select>
                  </div>
